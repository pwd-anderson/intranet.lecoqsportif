SELECT
    ...
    BPA.CTY_0       AS VILLE,
    SOH.ZCLASSE_0,
    ISNULL((select sum(c.QTE_RESTANTE) from MASTER_TABLES.COMMANDES_INTERSITES c where c.SITE_RECEPTION = 'WLOGM' AND c.ITMREF_0 = SOQ.ITMREF_0), 0) AS EN_TRANSIT_WLOGM,
    ISNULL((select sum(c.QTE_RESTANTE) from MASTER_TABLES.COMMANDES_INTERSITES c where c.SITE_RECEPTION = 'WSFCN' AND c.ITMREF_0 = SOQ.ITMREF_0), 0) AS EN_TRANSIT_WSFCN,
    ISNULL((select sum(c.QTE_RESTANTE) from MASTER_TABLES.COMMANDES_INTERSITES c where c.SITE_RECEPTION = 'WTAKH' AND c.ITMREF_0 = SOQ.ITMREF_0), 0) AS EN_TRANSIT_WTAKH,
    ISNULL((select sum(c.QTE_RESTANTE) from MASTER_TABLES.COMMANDES_INTERSITES c where c.SITE_RECEPTION = 'WDTTH' AND c.ITMREF_0 = SOQ.ITMREF_0), 0) AS EN_TRANSIT_WDTTH,
    ISNULL((select sum(poq2.QTYUOM_0 - poq2.RCPQTYSTU_0) from X3_LCS.PORDERQ poq2 inner join X3_LCS.PORDER poh2 on poq2.POHNUM_0 = poh2.POHNUM_0 where poq2.LINCLEFLG_0 = 1 AND poh2.BETFCY_0 <> 2 AND poq2.PRHFCY_0 = 'WLOGM' AND poq2.ITMREF_0 = SOQ.ITMREF_0), 0) AS BACKLOG_FOURNISSEUR_WLOGM,
    ISNULL((select sum(poq2.QTYUOM_0 - poq2.RCPQTYSTU_0) from X3_LCS.PORDERQ poq2 inner join X3_LCS.PORDER poh2 on poq2.POHNUM_0 = poh2.POHNUM_0 where poq2.LINCLEFLG_0 = 1 AND poh2.BETFCY_0 <> 2 AND poq2.PRHFCY_0 = 'WSFCN' AND poq2.ITMREF_0 = SOQ.ITMREF_0), 0) AS BACKLOG_FOURNISSEUR_WSFCN,
    ISNULL((select sum(poq2.QTYUOM_0 - poq2.RCPQTYSTU_0) from X3_LCS.PORDERQ poq2 inner join X3_LCS.PORDER poh2 on poq2.POHNUM_0 = poh2.POHNUM_0 where poq2.LINCLEFLG_0 = 1 AND poh2.BETFCY_0 <> 2 AND poq2.PRHFCY_0 = 'WTAKH' AND poq2.ITMREF_0 = SOQ.ITMREF_0), 0) AS BACKLOG_FOURNISSEUR_WTAKH,
    ISNULL((select sum(poq2.QTYUOM_0 - poq2.RCPQTYSTU_0) from X3_LCS.PORDERQ poq2 inner join X3_LCS.PORDER poh2 on poq2.POHNUM_0 = poh2.POHNUM_0 where poq2.LINCLEFLG_0 = 1 AND poh2.BETFCY_0 <> 2 AND poq2.PRHFCY_0 = 'WDTTH' AND poq2.ITMREF_0 = SOQ.ITMREF_0), 0) AS BACKLOG_FOURNISSEUR_WDTTH,
    COALESCE(PO.DATE_COMMANDE_FOURNISSEUR, CI.DATE_COMMANDE_FOURNISSEUR) AS DATE_COMMANDE_FOURNISSEUR,
    ISNULL(STK.STOCK_REEL_WLOGM, 0)    AS STOCK_REEL_WLOGM,
    ISNULL(STK.STOCK_INTERNE_WLOGM, 0) AS STOCK_INTERNE_WLOGM,
    ISNULL(STK.STOCK_REEL_WSFCN, 0)    AS STOCK_REEL_WSFCN,
    ISNULL(STK.STOCK_INTERNE_WSFCN, 0) AS STOCK_INTERNE_WSFCN,
    ISNULL(STK.STOCK_REEL_WTAKH, 0)    AS STOCK_REEL_WTAKH,
    ISNULL(STK.STOCK_INTERNE_WTAKH, 0) AS STOCK_INTERNE_WTAKH,
    ISNULL(STK.STOCK_REEL_WDTTH, 0)    AS STOCK_REEL_WDTTH,
    ISNULL(STK.STOCK_INTERNE_WDTTH, 0) AS STOCK_INTERNE_WDTTH,
    (ISNULL(STK.STOCK_REEL_WLOGM, 0) + ISNULL((select sum(c.QTE_RESTANTE) from MASTER_TABLES.COMMANDES_INTERSITES c where c.SITE_RECEPTION = 'WLOGM' AND c.ITMREF_0 = SOQ.ITMREF_0), 0)) AS STOCK_A_TERME_TRANSIT_WLOGM,
    (ISNULL(STK.STOCK_REEL_WSFCN, 0) + ISNULL((select sum(c.QTE_RESTANTE) from MASTER_TABLES.COMMANDES_INTERSITES c where c.SITE_RECEPTION = 'WSFCN' AND c.ITMREF_0 = SOQ.ITMREF_0), 0)) AS STOCK_A_TERME_TRANSIT_WSFCN,
    (ISNULL(STK.STOCK_REEL_WTAKH, 0) + ISNULL((select sum(c.QTE_RESTANTE) from MASTER_TABLES.COMMANDES_INTERSITES c where c.SITE_RECEPTION = 'WTAKH' AND c.ITMREF_0 = SOQ.ITMREF_0), 0)) AS STOCK_A_TERME_TRANSIT_WTAKH,
    (ISNULL(STK.STOCK_REEL_WDTTH, 0) + ISNULL((select sum(c.QTE_RESTANTE) from MASTER_TABLES.COMMANDES_INTERSITES c where c.SITE_RECEPTION = 'WDTTH' AND c.ITMREF_0 = SOQ.ITMREF_0), 0)) AS STOCK_A_TERME_TRANSIT_WDTTH,
    (ISNULL(STK.STOCK_REEL_WLOGM, 0)
    ...
    ) AS STOCK_A_TERME_BACKLOG_FOURNISSEUR_WLOGM,
    (ISNULL(STK.STOCK_REEL_WSFCN, 0)
    ...
    ) AS STOCK_A_TERME_BACKLOG_FOURNISSEUR_WSFCN,
    (ISNULL(STK.STOCK_REEL_WTAKH, 0)
    ...
    ) AS STOCK_A_TERME_BACKLOG_FOURNISSEUR_WTAKH,
    (ISNULL(STK.STOCK_REEL_WDTTH, 0)
    ...
    ) AS STOCK_A_TERME_BACKLOG_FOURNISSEUR_WDTTH,
    NULL AS STOCK
...
INNER JOIN X3_LCS.BPCUSTOMER BPC ON SOH.BPCORD_0 = BPC.BPCNUM_0
    ...
    -- dans les transferts intersites en cours vers le site de la commande (même logique
    -- que EN_TRANSIT_<SITE>, mais restreinte au site de la commande, pas les 4 sites).
    LEFT  JOIN (
