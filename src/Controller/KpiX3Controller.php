...
final class KpiX3Controller extends AbstractController
{
    #[Route('/kpi/retail_x3', name: 'app_kpi_retail_x3')]
    public function retail(Request $request): Response
    {
        ...
        return $this->render('kpi/retail_x3.html.twig', [
            'year' => $year,
            'week' => $week,
    ...
    #[Route('/kpi/retail_x3_ajax', name: 'kpi_retail_x3_ajax', methods: ['GET'])]
